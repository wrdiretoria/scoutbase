    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-white border-b border-gray-100 flex items-center px-4">
        ...
        <Link href="/" className="absolute left-1/2 -translate-x-1/2 text-lg font-bold select-none" style={{ textDecoration: 'none' }}>
          <span style={{ color: '#16a34a' }}>MEUCRAQUE</span><span style={{ color: '#6b7280' }}>.com</span>
        </Link>
      ...
      >
        ...
        >
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <Link href="/" className="text-lg font-bold" style={{ textDecoration: 'none' }}><span style={{ color: '#16a34a' }}>MEUCRAQUE</span><span style={{ color: '#6b7280' }}>.com</span></Link>
            <button
              onClick={() => setOpen(false)}
