    ...
    <div className="bg-[#09110d] text-white min-h-screen">
      ...
      <section className="py-24 px-6">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="font-[family-name:var(--font-bebas)] text-4xl sm:text-6xl tracking-wide text-white">
          ...
          <div className="mt-10">
            <Link
              href="/cadastro"
              className="inline-flex items-center gap-2 px-10 py-4 bg-[#16a34a] hover:bg-green-500 text-white font-semibold rounded-2xl text-base transition-colors shadow-lg shadow-green-900/30"
            >
              Criar conta grátis →
            </Link>
          </div>
